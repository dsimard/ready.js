...
var r = {
  ...
  loadConfig : function(extConfig) {
    ...
    r.config.analyse            = (argv["no-analyse"] !== undefined) ? !def.analyse : r.config.analyse;
    r.config.compile            = (argv["nocompiler"] !== undefined) ? !def.runGCompiler : r.config.runGCompiler;
    r.config.compile            = (argv["no-compile"] !== undefined) ? !def.compile : r.config.compile;
    r.config.recursive          = (argv["norecursive"] !== undefined) ? !def.recursive : r.config.recursive;
    r.config.recursive          = (argv["no-recursive"] !== undefined) ? !def.recursive : r.config.recursive;
